...
import com.example.msscolarite.repository.EtablissementRepository;
...
public class MsScolariteApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        etudiantRepository.save(new Etudiant(null,"malki", Date.valueOf("1999-01-01"),"2sc-siw",e1,1L,null,null));
        etudiantRepository.save(new Etudiant(null,"ali", Date.valueOf("1995-08-11"),"2sc-siw",e1,2L,null,null));
        etudiantRepository.save(new Etudiant(null,"karim", Date.valueOf("1996-11-22"),"2sc-siw",e2,1L,null,null));
        etudiantRepository.save(new Etudiant(null,"fouad", Date.valueOf("2000-02-15"),"2sc-siw",e2,1L,null,null));
    }
}
